...
public class ListSetMapDemo {
    public static void main(String[] args) {
        ...
        for (String page : pages) {
            visitHistory.add(page); uniquePages.add(page); pageCounts.put(page, pageCounts.getOrDefault(page, 0) + 1);
        }
        System.out.println("歷程：" + visitHistory); System.out.println("不重複頁面：" + uniquePages); System.out.println("Home 次數：" + pageCounts.get("Home"));
    }
}
